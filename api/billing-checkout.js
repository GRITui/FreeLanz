 ...
 *
 * Factory shape (opts.getSql/opts.getStripeClient) matches
 * api/booking-requests.js's seam, so tests/test-billing.mjs can swap in an
 * in-memory fake sql and a fake Stripe client without a live Neon
 * connection or a real Stripe account.
 */
...
export function createBillingCheckoutHandler(opts = {}) {
